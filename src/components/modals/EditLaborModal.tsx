...
import type { Labor } from '../../types/database';
...
export default function EditLaborModal({ isOpen, onClose, onSuccess, laborer }: EditLaborModalProps) {
  ...
  useEffect(() => {
    if (laborer) {
      setFormData({
        name: laborer.name,
        photo_url: laborer.photo_url || '',
        phone: laborer.phone,
        address: laborer.address,
        role: laborer.role,
        salary_type: laborer.salary_type,
        salary_amount: laborer.salary_amount.toString(),
      });
    }
  }, [laborer]);
      ...
      <div className="bg-white rounded-xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-xl">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Edit Workforce Member</h2>
          </div>
          <button
            onClick={onClose}
